...
export REPO_SUBLIME_TEXT_SETUP=v5.1.0
...
export TRAILER_APP_URL="http://ptsochantaris.github.io/trailer/trailer150.zip"
...
export ELM_EXTENSION_URL="https://github.com/deadfoxygrandpa/Elm.tmLanguage.git"
...
export NGINX_EXTENSION_PATH="$SUBLIME_TEXT_EXTENSION_ROOT/nginx"
export NGINX_EXTENSION_URL="https://github.com/brandonwamboldt/sublime-nginx.git"
...
export QUICK_FILE_MOVE_EXTENSION_PATH="$SUBLIME_TEXT_EXTENSION_ROOT/Quick File Move"
export QUICK_FILE_MOVE_EXTENSION_URL="https://github.com/wulftone/sublime-text-quick-file-move.git"
export RUBOCOP_EXTENSION_PATH="$SUBLIME_TEXT_EXTENSION_ROOT/SublimeLinter-ruby"
export RUBOCOP_EXTENSION_URL="https://github.com/SublimeLinter/SublimeLinter-rubocop.git"
...
export RUBY_LINT_EXTENSION_PATH="$SUBLIME_TEXT_EXTENSION_ROOT/SublimeLinter-ruby"
export RUBY_LINT_EXTENSION_URL="https://github.com/SublimeLinter/SublimeLinter-ruby.git"
...
export THEME_AFTERGLOW_EXTENSION_PATH="$SUBLIME_TEXT_EXTENSION_ROOT/Theme - Afterglow"
export THEME_AFTERGLOW_EXTENSION_URL="https://github.com/YabataDesign/afterglow-theme.git"
